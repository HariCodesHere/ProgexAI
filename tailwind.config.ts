  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "ai-orange": "hsl(var(--ai-orange))",
        // Warm light mode colors
        "amber-25": "#fefcf3", // Very light warm amber
        "warm-50": "#faf9f7", // Warm white
        "warm-100": "#f5f3f0", // Light warm gray
        sidebar: {
      ...
      backgroundImage: {
        ...
        "ai-gradient-subtle":
          "linear-gradient(135deg, hsl(var(--ai-gradient-start) / 0.1), hsl(var(--ai-gradient-end) / 0.1))",
      },
      keyframes: {
        "accordion-down": {
          from: {
